...
public struct PandaMQTTPayload {
    ...
    public static func parse(from data: Data) -> PandaMQTTPayload? {
    ...
    private static func parseInfo(_ infoData: [String: Any]) -> PandaMQTTPayload? {
